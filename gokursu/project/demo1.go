...
func GetAllProducts() ([]Product, error) {
	...
	json.Unmarshal(bodyBytes, &products) //json formatından struct formatına çevirdik
...
func AddProduct() (Product, error) {
	product := Product{ProductName: "Laptop2", CategoryId: 1, UnitPrice: 10000.0} //id vermesek de olur
